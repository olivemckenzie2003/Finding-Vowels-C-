...
int main() {
    ...
    for (int month = 1; month <= 12; month++) {
        // Print the title and get the number of days in a month
        switch (month) {
            case 1:
        ...
        // Print initial empty slots in calendar
        ...
        // Set up the starting point for the next month
        starting_point = (day_counter == 0) ? 1 : day_counter + 1;
        day_counter = 0;
        cout << "\n\n"; // Extra line between months for readability
    }
